...
Before changing app behavior, UI copy, data models, authentication, deployment flow, or tests, read `docs/especificaciones.md`.
That Spanish document is the product and acceptance reference for this sample app. Keep implementation changes aligned with it, and update it when the intended behavior changes.
